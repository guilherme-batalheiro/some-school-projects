...
{
  var x = parseInt(LEFT_PADDING) + parseInt((i % 3) * (TARGET_SIZE + TARGET_PADDING) + MARGIN) - TARGET_SIZE*1/2*4/3;
  var y = parseInt(TOP_PADDING) + parseInt(Math.floor(i / 3) * (TARGET_SIZE + TARGET_PADDING) + MARGIN) - TARGET_SIZE*1/2*4/3;

  return new Square(x, y, TARGET_SIZE*4/3);
}
